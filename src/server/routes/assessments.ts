...
// Analyze inconsistencies in a risk assessment (DEPRECATED: Use frontend Gemini API directly)
router.post("/:id/analyze", async (req, res) => {
  res.status(410).json({ 
    status: "error", 
    message: "This endpoint is deprecated. AI analysis must be performed on the client side." 
  });
});
